...
####################################
CombRF_Env_v4 - RF base station Environment for Multi-armed bandit problem
...
class CombRF_Env_v4(gym.Env):
    def __init__(self):
        ...
        self.sc_xyz = np.array([])#np.array([[-100,50,0], [-100,-50,0], [-50,100,0],[50,100,0]])#np.array([[0,100,0], [10,50,0], [40,60,0], [70,80,0], [100,50,0], [80,85,0], [20,30,0], [10,40,0], [80,20,0]])#np.array([[0,100,0]])#np.array([[0,100,0],[250,0,0],[-200,-150,0]]) #reflection points for now
    ...
    def get_rssi_range(self):
        ...
        sc = np.array([])#np.array([[-100,50,0], [-100,-50,0], [-50,100,0],[50,100,0]])
        ch_model = 'uma-los'
    ...
    def get_minmax_exhrate(self, ch_randval):
        ...
        self.tx_num = self.get_txloc_ndx(self.tx_loc)
        channel.generate_paths(ch_randval, self.tx_num)
